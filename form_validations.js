$(document).ready(function () {
  fetch(
    'https://raw.githubusercontent.com/Octagram-labs/perdoo/main/blacklist_emails.json',
  )
    ...
    .then((data) => {
      ...
      $('#requestDemoForm').validate({
        ...
        errorPlacement: function (error, element) {
          if (element.attr('name') === 'demoPrivacy') {
            error.insertAfter(
              element.closest('[data-name="requestDemoCheckbox"]'),
            );
          } else if (element.attr('name') === 'demoPosition') {
            error.insertAfter(element);
          } else {
            // Check if element has data-name="checkbox" attribute
            const checkboxDiv = element.closest(
              '[data-name="requestDemoCheckbox"]',
            );
            if (checkboxDiv.length) {
              error.insertAfter(checkboxDiv);
            } else {
      ...
      $('#newsletterForm').validate({
        ...
        errorPlacement: function (error, element) {
          if (element.attr('name') === 'newsletterPrivacy') {
            error.insertAfter(
              element.closest('[data-name="newsletterCheckbox"]'),
            );
          } else if (element.attr('name') === 'newsletterEmail') {
            error.insertAfter(element);
          } else {
            // Check if element has data-name="checkbox" attribute
            const checkboxDiv = element.closest(
              '[data-name="newsletterCheckbox"]',
            );
            if (checkboxDiv.length) {
              error.insertAfter(checkboxDiv);
            } else {
      ...
      $('#salesForm').validate({
        ...
        errorPlacement: function (error, element) {
          if (element.attr('name') === 'salesPrivacy') {
            error.insertAfter(
              element.closest('[data-name="salesFormCheckbox"]'),
            );
      ...
      $('#securityForm').validate({
        ...
        errorPlacement: function (error, element) {
          if (element.attr('name') === 'securityPrivacy') {
            error.insertAfter(
              element.closest('[data-name="securityFormCheckbox"]'),
            );
            ...
            // Check if element has data-name="checkbox" attribute
            const checkboxDiv = element.closest(
              '[data-name="securityFormCheckbox"]',
            );
            if (checkboxDiv.length) {
              error.insertAfter(checkboxDiv);
            } else {
